{
  nixantic.sources.agent-delegation.blocks."sub-agents-workflows" = rec {
    ...
    taggedContent = ''
      * Main agent:
        * Used primarily for high-level orchestration, project management, jj (code versioning). Main agent context window is VERY VERY precious; Anything requiring reading, understanding and exploring code should be delegated to sub-agents.
