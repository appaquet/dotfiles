  ...
  nixantic.sources.development-workflow.blocks."testing-principles" =
    { scope }:
    {
      ...
      taggedContent = ''
        ...
        * Failues: when test fails, use ${scope.blocks.problem-solving.reference} to investigate root cause. Dont' modify test to make it pass, unless it's genuinely wrong
        ...
        * Useer testing: If not possible or hard to test, involve user for manual tests with clear tasks and ACs. Should be last resort.
      '';
    };
}
