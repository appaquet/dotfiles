fish_add_path -g /nix/store/cwz1v7amw3dwz246nr3ygnmnlv64pkf3-rtx-v1.18.0/bin
...
function rtx
  ...
  case deactivate shell
    source (/nix/store/cwz1v7amw3dwz246nr3ygnmnlv64pkf3-rtx-v1.18.0/bin/rtx "$command" $argv|psub)
  case '*'
    command /nix/store/cwz1v7amw3dwz246nr3ygnmnlv64pkf3-rtx-v1.18.0/bin/rtx "$command" $argv
  end
end

function __rtx_env_eval --on-event fish_prompt --description 'Update rtx environment when changing directories';
    /nix/store/cwz1v7amw3dwz246nr3ygnmnlv64pkf3-rtx-v1.18.0/bin/rtx hook-env -s fish | source;
